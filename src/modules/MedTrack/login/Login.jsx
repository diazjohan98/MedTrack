      ...
      <div className='containerLogin'>
        ...
        <form>
          ...
          <div className='containerBtnLogin'>
            <button type="submit" className="btn btn-primary mb-3 rounded-pill">Iniciar Sesión</button>
            ...
            <button type="submit" className="btn btn-outline-primary mb-3 rounded-pill" >Crear cuenta</button>
          </div>
        </form>
      </div>
